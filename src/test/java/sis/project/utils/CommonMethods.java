...
import sis.project.testbase.PageInitializer;
...
public class CommonMethods extends PageInitializer{
	...
	/**
	 * This methods checks if the radio/check box is enabled, and then clicks on the
	 * element that matches the selected value
	 * 
	 * @param elementList
	 * @param selectValue
	 */
	...
	/**
	 * This method switches the focus to an Alert and accepts if found if not found,
	...
	/**
	 * This method dismisses an alert if it's present if not present, an exception
	 * will be thrown
	 */
	...
	/**
	 * This method will return the alert text if the alert present if not, null will
	 * be returned
	 * 
	 * @return
	 */
